                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        ...
                                        @csrf
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="passwordagain"class="form-control py-4" id="inputConfirmPassword" type="password" placeholder="Confirm password" />
                                                        @if($errors->has('password'))
                                            ...
                                            <button style="width:100%;" type="submit" class="btn btn-primary btn-block btn-flat">Register</button>
                                        </form>
                                    </div>
